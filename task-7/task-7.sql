...
--drop constraints 
ALTER TABLE EMPLOYEE DROP CONSTRAINT FK__EMPLOYEE__MANAGE__3D5E1FD2

--DROP THE COLUMN
ALTER TABLE EMPLOYEE DROP COLUMN MANAGER_ID

--add constraint (on delete cascade on update set default)
ALTER TABLE EMPLOYEE ADD MANAGER_ID INT DEFAULT 3 CONSTRAINT FK__EMPLOYEE__MANAGE FOREIGN KEY (MANAGER_ID) REFERENCES MANAGER(MANAGER_ID) ON DELETE CASCADE ON UPDATE SET DEFAULT 
...
UPDATE MANAGER SET MANAGER_ID=4 WHERE MANAGER_ID=5
